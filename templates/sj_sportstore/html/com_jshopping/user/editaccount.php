...
?>
	...
	<div class="sjhop_register_theme1">

        <?php if ($config_fields['title']['display']){?>
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_REG_TITLE ?> <?php if ($config_fields['title']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_F_NAME ?> <?php if ($config_fields['f_name']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_L_NAME ?> <?php if ($config_fields['l_name']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_M_NAME ?> <?php if ($config_fields['m_name']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_FIRMA_NAME ?> <?php if ($config_fields['firma_name']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_CLIENT_TYPE ?> <?php if ($config_fields['client_type']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <?php if ($config_fields['firma_code']['display']){?>
		 <div class="control-group" id='tr_field_firma_code' <?php if ($this->user->client_type!="2"){?>style="display:none;"<?php } ?>>
			<div class="control-label">
				<label><?php print _JSHOP_FIRMA_CODE ?> <?php if ($config_fields['firma_code']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
		...
		<div class="control-group" id='tr_field_tax_number' <?php if ($this->user->client_type!="2"){?>style="display:none;"<?php } ?>>
			<div class="control-label">
				<label><?php print _JSHOP_VAT_NUMBER ?> <?php if ($config_fields['tax_number']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_EMAIL ?> <?php if ($config_fields['email']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_BIRTHDAY ?> <?php if ($config_fields['birthday']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_HOME ?> <?php if ($config_fields['home']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_APARTMENT ?> <?php if ($config_fields['apartment']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <?php if ($config_fields['street']['display']){?>
         <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_STREET_NR ?> <?php if ($config_fields['street']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_ZIP ?> <?php if ($config_fields['zip']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_CITY ?> <?php if ($config_fields['city']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_STATE ?> <?php if ($config_fields['state']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_COUNTRY ?> <?php if ($config_fields['country']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_TELEFON ?> <?php if ($config_fields['phone']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_MOBIL_PHONE ?> <?php if ($config_fields['mobil_phone']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_FAX ?> <?php if ($config_fields['fax']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_EXT_FIELD_1 ?> <?php if ($config_fields['ext_field_1']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_EXT_FIELD_2 ?> <?php if ($config_fields['ext_field_2']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_EXT_FIELD_3 ?> <?php if ($config_fields['ext_field_3']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_PASSWORD ?> <?php if ($config_fields['password']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_PASSWORD_2 ?> <?php if ($config_fields['password_2']['require']){?><span>*</span><?php } ?></label>
          	</div>
			<div class="controls">
    ...
    <?php if ($this->count_filed_delivery > 0){?>
     <div class="other-address">
    	<div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_DELIVERY_ADRESS ?></label>
			</div>
          	<div class="controls">
    ...
    <div id = "div_delivery" class = "jshop_register" style = "padding-bottom:0px;<?php if (!$this->delivery_adress){ ?>display:none;<?php } ?>" >
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_REG_TITLE ?> <?php if ($config_fields['d_title']['require']){?><span>*</span><?php } ?></label>
          	</div>
          	<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_F_NAME ?> <?php if ($config_fields['d_f_name']['require']){?><span>*</span><?php } ?></label>
          	</div>
          	<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_L_NAME ?> <?php if ($config_fields['d_l_name']['require']){?><span>*</span><?php } ?></label>
          	</div>
          	<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_M_NAME ?> <?php if ($config_fields['d_m_name']['require']){?><span>*</span><?php } ?></label>
          	</div>
          	<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_FIRMA_NAME ?> <?php if ($config_fields['d_firma_name']['require']){?><span>*</span><?php } ?></label>
          	</div>
          	<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_EMAIL ?> <?php if ($config_fields['d_email']['require']){?><span>*</span><?php } ?></label>
          	</div>
          	<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_BIRTHDAY ?> <?php if ($config_fields['d_birthday']['require']){?><span>*</span><?php } ?></label>
          	</div>
          	<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_HOME ?> <?php if ($config_fields['d_home']['require']){?><span>*</span><?php } ?></label>
          	</div>
          	<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_APARTMENT ?> <?php if ($config_fields['d_apartment']['require']){?><span>*</span><?php } ?></label>
          	</div>
          	<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_STREET_NR ?> <?php if ($config_fields['d_street']['require']){?><span>*</span><?php } ?></label>
          	</div>
          	<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_ZIP ?> <?php if ($config_fields['d_zip']['require']){?><span>*</span><?php } ?></label>
          	</div>
          	<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_CITY ?> <?php if ($config_fields['d_city']['require']){?><span>*</span><?php } ?></label>
          	</div>
          	<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_STATE ?> <?php if ($config_fields['d_state']['require']){?><span>*</span><?php } ?></label>
          	</div>
          	<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_COUNTRY ?> <?php if ($config_fields['d_country']['require']){?><span>*</span><?php } ?></label>
          	</div>
          	<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_TELEFON ?> <?php if ($config_fields['d_phone']['require']){?><span>*</span><?php } ?></label>
          	</div>
          	<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_MOBIL_PHONE ?> <?php if ($config_fields['d_mobil_phone']['require']){?><span>*</span><?php } ?></label>
          	</div>
          	<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_FAX ?> <?php if ($config_fields['d_fax']['require']){?><span>*</span><?php } ?></label>
          	</div>
          	<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_EXT_FIELD_1 ?> <?php if ($config_fields['d_ext_field_1']['require']){?><span>*</span><?php } ?></label>
          	</div>
          	<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_EXT_FIELD_2 ?> <?php if ($config_fields['d_ext_field_2']['require']){?><span>*</span><?php } ?></label>
          	</div>
          	<div class="controls">
        ...
        <div class="control-group">
			<div class="control-label">
				<label><?php print _JSHOP_EXT_FIELD_3 ?> <?php if ($config_fields['d_ext_field_3']['require']){?><span>*</span><?php } ?></label>
          	</div>
          	<div class="controls">
    ...
    <div class="jshop_block_privacy_statement">    
    	<div class="control-group">
			<div class="control-label">
				<label><a class="privacy_statement" href="#" onclick="window.open('<?php print SEFLink('index.php?option=com_jshopping&controller=content&task=view&page=privacy_statement&tmpl=component', 1);?>','window','width=800, height=600, scrollbars=yes, status=no, toolbar=no, menubar=no, resizable=yes, location=no');return false;">
