...
<div class = "jshop">
    <?php foreach($this->rows as $k=>$row){?>
        <?php if ($k%$this->count_manufacturer_to_row==0) print '<div class="sj-row clearfix">';?>
        <?php /*?><div class = "jshop_categ" width = "<?php print (100/$this->count_manufacturer_to_row)?>%"><?php */?>
		<div class = "jshop_categ sj-column span<?php print floor(12/$this->count_manufacturer_to_row);?>">
        ...
        <?php if ($k%$this->count_manufacturer_to_row==$this->count_manufacturer_to_row-1) print "</div>";?>
	 <?php } ?>
     <?php if ($k%$this->count_manufacturer_to_row!=$this->count_manufacturer_to_row-1) print "</div>";?>
</div>
</div>
