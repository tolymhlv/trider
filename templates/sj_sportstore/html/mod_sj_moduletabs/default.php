...
JHtml::stylesheet('templates/' . JFactory::getApplication()->getTemplate().'/html/mod_sj_moduletabs/moduletabs.css');
	...
	<div class="tabs-container">
		...
		<?php 
			...
			foreach($listmodules as $_module) {
				...
				$cnn++;							
		?>
			<li><div class="<?php echo $css_selected .' tabs'.$cnn; ?>"><?php echo $_module->title ?></div></li>
		<?php 
			}
		?>
		</ul>
