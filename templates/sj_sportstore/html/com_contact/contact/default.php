...
<?php endif; ?>
	...
	<?php if ($this->params->get('show_email_form') && ($this->contact->email_to || $this->contact->user_id)) : ?>
		...
		<div class="panel-form">
            <?php if ($this->params->get('presentation_style')=='plain'):?>
                <?php  echo '<h3 class="title">'. JText::_('COM_CONTACT_EMAIL_FORM').'</h3>';  ?>
            <?php endif; ?>
	...
	<div class="google-map">
		<iframe width="100%" height="324" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?ie=UTF8&amp;t=m&amp;ll=37.830124,-122.271008&amp;spn=0.013558,0.021415&amp;z=15&amp;output=embed"></iframe>
	</div>
