...
{
	$button = '<button class="button' . $suffix . ' finder' . $suffix . '" type="submit"> '. JText::_('JFINDER_SEARCH_BUTTON') . '</button>';
	//$button = '<button class="button' . $suffix . ' finder' . $suffix . '" type="submit"><i class="icon-search"></i></button>';
...
<div class="mod-finder-searchform-custom">
	...
	<div class="res-mod-finder">
		<button class="btn-search"><?php JText::_('JFINDER_SEARCH_BUTTON');?><i class="icon-search"></i></button>
			...
			<div class="dropdown-search-inner">
				<form id="mod-finder-searchform" action="<?php echo JRoute::_($route); ?>" method="get">
					<div class="finder<?php echo $suffix; ?>">
						...
						//echo $output;						
						?>
						<?php echo '<input type="text" name="q" id="mod-finder-searchword" class="inputbox" size="' . $params->get('field_size', 20) . '" value="' . htmlspecialchars(JFactory::getApplication()->input->get('q', '', 'string')) . '" />';
						 	echo '<button class="button' . $suffix . ' finder' . $suffix . '" type="submit"> '. JText::_('JFINDER_SEARCH_BUTTON') . '</button>';
						?>
