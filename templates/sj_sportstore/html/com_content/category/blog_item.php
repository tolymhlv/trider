	...
	<div class="pull-<?php echo htmlspecialchars($imgfloat); ?> item-image" style="min-width:<?php echo $imgW ?>px;min-height:<?php echo $imgH ?>px"> 
		...
		<div class="image-overlay">
			<div class="hover-links clearfix">
				...
				<?php /*?><a class="hover-zoom" data-rel="prettyPhoto" title="<?php echo $images->image_intro_caption;?>" href="<?php echo htmlspecialchars($images->image_intro); ?>"><i class="icon-external-link"></i></a>
	...
	<div class="item-footerinfo">
     <dl class="article-info muted">
		...
		<?php if ($params->get('show_publish_date')) : ?>
				...
				<?php echo JText::_('PUBLISHED_DATE'); ?>			
				<?php echo JHTML::_('date', $this->item->publish_up, 'M d, Y');?>
				</dd>
		<?php endif; ?>	
		<?php if ($params->get('show_modify_date')) : ?>
				<dd class="modified">
				<?php echo JText::_('MODIFY_DATE'); ?>
				<?php echo JHTML::_('date', $this->item->modified, 'M d, Y');?>
				<?php //echo date_format(date_create($item['created']),'d F Y'); ?>
				</dd>
		<?php endif; ?>		
    </dl>
	</div>
