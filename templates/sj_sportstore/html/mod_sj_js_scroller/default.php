...
defined('_JEXEC') or die;
	...
	JHtml::stylesheet('templates/' . JFactory::getApplication()->getTemplate().'/html/mod_sj_js_scroller/css/styles.css');
	...
	<div  class="scroller-container <?php echo $params->get('nav_style','nav_style1');	?>" style="height:<?php echo $params->get('imgcfg_height',400); ?>px;">
		...
		?>
			<div class="ns-item"  data-iview:thumbnail="<?php  echo $small_img; ?>" data-iview:image="<?php  echo $img; ?>">
				...
				<div class="iview-caption caption-title " data-x="<?php echo (int)$params->get('item_title_data_x',50); ?>" data-y="<?php echo (int)$params->get('item_title_data_y',80); ?>"  data-transition="<?php echo $params->get('item_title_transition','wipeleft'); ?>" >
				...
				<div class="iview-caption caption-redmore" data-x="<?php echo (int)$params->get('item_readmore_data_x',50); ?>" data-y="<?php echo (int)$params->get('item_readmore_data_y',220); ?>"  data-transition="<?php echo $params->get('item_readmore_transition','expanddown'); ?>" >
