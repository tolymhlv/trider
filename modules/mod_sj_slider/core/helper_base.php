...
if (!class_exists('BaseHelperSliderContent')){
	/**
	 * BaseHelper for com_content only.
	 */
	abstract class BaseHelperSliderContent{
		/**
		...
		*/
		 ...
		 */
		public static function getSJImage($item, $params, $prefix='imgcfg'){
			$images = &self::getSJImages($item, $params, $prefix);
		 ...
		 * @param unknown_type $params
		 */
		public static function getSJImages($item, $params, $prefix='imgcfg'){
