...
<?php }?>
	...
	<a class="twitter-timeline" href="<?php echo $href;?>" data-widget-id="<?php echo $widgets_id;?>" data-tweet-limit="<?php echo $limit;?>" width="<?php //echo $width;?>" height="<?php //echo $height;?>" data-chrome="noheader nofooter noborders transparent " data-border-color="transparent" data-theme="<?php echo $theme;?>"></a>
